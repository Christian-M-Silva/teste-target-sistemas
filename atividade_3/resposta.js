...
console.log("Menor valor de faturamento ocorrido em um dia:", menorFaturamento.toFixed(2));
console.log("Maior valor de faturamento ocorrido em um dia:", maiorFaturamento.toFixed(2));
